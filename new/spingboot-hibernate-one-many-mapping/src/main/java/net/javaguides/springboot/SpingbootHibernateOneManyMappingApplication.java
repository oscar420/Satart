...
public class SpingbootHibernateOneManyMappingApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(SpingbootHibernateOneManyMappingApplication.class, args);
	}
